...
function header() {
  ...
  <nav class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-6">
    ...
    <a href="#demo" class="btn btn-primary px-5 py-2.5 text-sm">Book a Demo <i data-lucide="arrow-right" class="w-4 h-4"></i></a>
  </nav>
</header>`;
}
  ...
  <div class="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_.95fr] gap-10 items-center">
    <div>
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        <a href="#demo" class="btn btn-primary px-8 py-4">${esc(cta)} <i data-lucide="arrow-right" class="w-5 h-5"></i></a>
...
function ctaBlock(title = 'Ready to stop missing calls?', text = 'Book a free demo and we will show how WiseCall can fit your call flow, team and current phone setup.') {
  ...
  <div class="max-w-5xl mx-auto text-center card-strong p-10 md:p-14">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      <a href="mailto:${site.email}?subject=WiseCall demo request" class="btn btn-primary px-8 py-4">Book a Free 15-Minute Demo</a>
...
function renderIndustryPage(industry) {
  ...
  const body = `${hero({
    ...
    cta: industry.slug === 'estate-agents' ? 'Book a Demo for Your Agency' : `Book a Demo for Your ${industry.singular}`,
