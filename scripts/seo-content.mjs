...
export const ukAiReceptionistComparison = {
  ...
  sources: [
    ...
    { name: 'Hey Jodie', href: 'https://heyjodie.com/en-gb/pricing/' },
    { name: 'Fonio', href: 'https://www.fonio.ai/en/pricing' },
    { name: 'whoza', href: 'https://whoza.ai/pricing' },
    { name: 'IONOS', href: 'https://www.ionos.co.uk/momentum/ai-receptionist' },
  ],
  columns: [
    { name: 'WiseCall', href: 'https://wisecall.io/pricing/' },
    { name: 'Hey Jodie', href: 'https://heyjodie.com/en-gb/pricing/' },
    ...
    { name: 'whoza', href: 'https://whoza.ai/pricing' },
    { name: 'IONOS', href: 'https://www.ionos.co.uk/momentum/ai-receptionist' },
    { name: 'Moneypenny', href: '' },
  ],
  rows: [
    [
      'From',
      '£99/mo rolling, or £84.15/mo billed yearly',
      '£49/mo Basic',
      '€99/mo Solo, or €84/mo billed yearly',
      '£59/mo Starter',
      '£39/mo excl. VAT',
      'Quote',
    ],
    [
      'That plan includes',
      '100 AI calls, plus email, WhatsApp, live chat and SMS',
      'Unlimited minutes. Bookings and transfers from Professional (£99)',
      '1,000 minutes, 1 number, 1 user',
      '10 jobs and 100 minutes. Extra jobs £4.50',
      '30 calls, then 49p each. One forwarding destination',
      'Not published',
    ],
    [
      'Next plan up',
      'Professional £199/mo (£169.15 yearly), 300 AI calls',
      'Professional £99/mo',
      'Team €299/mo (€254 yearly), 3,000 minutes',
      'Growth £125/mo, 20 jobs',
      '£69/mo, 100 calls then 39p each',
      'Quote',
    ],
    [
      'Top published plan',
      'Business £399/mo rolling, £339.15 yearly, 750+ calls',
      'Premium £199/mo. Enterprise from £500',
      'Scale from €499/mo (€424 yearly)',
      'Pro £230 / Scale £399',
      'All-Flat £99/mo excl. VAT, unlimited calls',
      'Quote',
    ],
    [
      'Try it',
      '20 free inbound AI calls, no card',
      '7 days free, no card',
      '30-day money-back',
    ...
    [
      'Contract',
      '30-day rolling, or yearly at 15% off',
      'Month to month',
      'Monthly or yearly (15% off)',
      'No contract',
      'Subscription',
    ...
    [
      'Same agent on',
      'Phone, email, WhatsApp, live chat, SMS',
      'Phone. App to manage calls',
      'Phone. WhatsApp is a separate plan',
      'Phone, then WhatsApp',
      'Phone',
      'Phone, with a person on higher products',
    ],
    [
      'Built for',
      'UK service businesses: dental, legal, property, trades, care',
      'UK small businesses that want a flat bill',
      'DACH first, selling into the UK',
      'UK trades only',
      'People already on IONOS',
      'Firms that want a person on the line',
    ],
    [
      'Extra charges',
      'Move plan if you outgrow the allowance',
      'None on unlimited minutes',
      '€15 per 100 extra minutes on Solo',
      'Extra jobs, and 40p/min over the cap',
      'Extra calls on the cheaper plans',
      'Quote',
    ],
  ],
  fonioColumns: ['', 'WiseCall', 'Fonio'],
  fonioRows: [
