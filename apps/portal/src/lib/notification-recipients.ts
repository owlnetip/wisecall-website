// Shared inbox resolution for post-call / chat emails.
...
/** Who receives the post-call team email for this agent. */
...
export function primaryInboxEmail(metadata: Record<string, unknown>): string {
  return defaultInboxEmails(metadata)[0] || "";
}
