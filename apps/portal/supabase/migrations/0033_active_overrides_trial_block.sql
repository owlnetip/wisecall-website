-- Paid customers must be able to take calls after upgrading from a capped trial.
-- Previously trial_blocked was checked first, so a lingering flag kept answering
-- off even after Stripe status became active.
