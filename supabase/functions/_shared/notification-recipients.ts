...
// Keep in sync with apps/portal/src/lib/call-summary-email.ts.
 ...
 *
 * The portal "Default routing inbox" (default_routing_email) is the address
 * setup calls "Main email for messages & transcripts". That inbox always gets
 * the email when it is set. Keyword-matched notify contacts are added on top.
 * If the default inbox is empty, people marked "Email summary" still get it.
 */
